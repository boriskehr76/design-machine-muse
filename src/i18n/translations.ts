...
export const translations = {
  en: {
    ...
    "skills.col3.title": "THE SEAM",
    "skills.badge.new": "new",
    "skills.ml.1": "Supervised & unsupervised learning",
    "skills.ml.2": "Clustering & segmentation",
    "skills.ml.3": "Regression & classification",
    "skills.ml.4": "Anomaly detection",
    "skills.ml.5": "Python, Pandas, sklearn",
    "skills.ml.6": "SQL",
    ...
    "skills.dx.6": "Figma, Framer, Miro, Notion",
  ...
  sv: {
    ...
    "skills.intro":
      "Tjugo år av produkttänkande, ett år av maskininlärning — och tillräckligt med nyfikenhet för att stänga gapet mellan dem. Jag vet hur tech-team fungerar, hur produkter byggs och hur man hittar vad användare faktiskt behöver. Jag kan bidra till ML-arbete, dokumentera det tydligt och förklara det för personer som inte pratar Python — i samma möte.",
    "skills.col1.title": "ML · UNDER UPPBYGGNAD",
    "skills.col2.title": "DESIGN · ETABLERAT",
    "skills.col3.title": "SKÄRNINGSPUNKTEN",
    "skills.badge.new": "nytt",
    "skills.ml.1": "Superviserad & icke-superviserad inlärning",
    "skills.ml.2": "Klustring & segmentering",
    "skills.ml.3": "Regression & klassificering",
    "skills.ml.4": "Anomalidetektion",
    "skills.ml.5": "Python, Pandas, sklearn",
    "skills.ml.6": "SQL",
    ...
    "skills.seam.2": "Skapa tillit och förutsägbarhet",
    "skills.seam.3": "Användarbehov → modellkrav",
    "skills.seam.4": "",
    "skills.seam.5": "Ansvarsfull AI",
